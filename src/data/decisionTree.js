  ...
  mobility: [
    {
      ...
      options: [
        ...
        },
        {
          ...
          api_criteria: { mobility: true, wheelchair_needed: true, productGroup: '09.12' },
        },
        {
          text: 'Ich kann nicht mehr selbstständig gehen',
          value: 'no_walking',
          leads_to: 'mobility_wheelchair_type',
          api_criteria: { mobility: true, wheelchair_needed: true, fulltime: true, productGroup: '09.12' },
        },
      ],
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          value: 'rollator',
          api_criteria: { productGroup: '09.12', rollator: true },
        },
      ],
    },
    {
      ...
      options: [
        ...
        { text: 'Treppen überwinden', value: 'stairs', api_criteria: { stairs: true, productGroup: '09.12' } },
      ],
    },
  ],
  bathroom: [
