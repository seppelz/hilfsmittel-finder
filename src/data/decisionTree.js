      ...
      options: [
        {
          ...
          api_criteria: { mobility: true, walker_needed: true, productGroup: '09' },
        },
        {
          text: 'Ich kann nur mit großer Mühe einige Schritte gehen',
          value: 'very_limited',
          leads_to: 'mobility_wheelchair',
          api_criteria: { mobility: true, wheelchair_needed: true, productGroup: '09' },
        },
        {
          text: 'Ich kann nicht mehr selbstständig gehen',
          value: 'no_walking',
          leads_to: 'mobility_wheelchair_type',
          api_criteria: { mobility: true, wheelchair_needed: true, fulltime: true, productGroup: '09' },
        },
      ],
    },
    {
      ...
      options: [
        {
          ...
          value: 'walker',
          api_criteria: { productGroup: '09', walker: true },
        },
        {
          text: 'Ich brauche Sitzpausen beim Gehen',
          value: 'rollator',
          api_criteria: { productGroup: '09', rollator: true },
        },
      ],
    },
    {
      ...
      options: [
        ...
        { text: 'Treppen überwinden', value: 'stairs', api_criteria: { stairs: true, productGroup: '09' } },
      ],
    },
  ],
  bathroom: [
